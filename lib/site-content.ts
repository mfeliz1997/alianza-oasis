...
export const siteContent = {
  ...
  logo: {
    src: "https://static.wixstatic.com/media/36237b_29d735b0dde74022aadbd5597a7f8e7a~mv2.png/v1/crop/x_2,y_81,w_495,h_360/fill/w_320,h_147,al_c,q_85,enc_auto/36237b_29d735b0dde74022aadbd5597a7f8e7a~mv2.png",
    alt: "Logo Iglesia Alianza Oasis",
  },
  /** Fallback si no hay video en Sanity (home). Sustituir por tu MP4 en producción. */
  heroVideoUrl:
    "https://videos.pexels.com/video-files/6774634/6774634-hd_1920_1080_24fps.mp4",
  mapEmbedUrl:
  ...
  serviceSchedule: [
    {
      ...
      note: "Familias apellido A–G (rotación semanal)",
      inPerson: true,
      streamed: true,
    },
    {
      ...
      languages: "Español",
      note: "Familias apellido H–O (rotación semanal)",
      inPerson: true,
      streamed: true,
    },
    {
    ...
    },
    {
      ...
      minute: 0,
      title: "Oasis Youth",
      timeLabel: "Sábado · 5:00 PM",
      languages: "Español",
      note: "Ministerio de jóvenes",
      inPerson: true,
      streamed: false,
    },
  ],
  ministries: [
    {
      ...
      schedule: "Viernes 8:00 PM · Sábados 5:00 PM (Oasis Youth)",
